...
(
    ...
    CustomerID INT REFERENCES CUSTOMER(CustomerID) ON DELETE RESTRICT NOT NULL,
    WineID     INT REFERENCES Wine(WineID)         ON DELETE RESTRICT NOT NULL,
...
(
    ...
    WineID         INT REFERENCES WINE(WineID)   ON DELETE RESTRICT NOT NULL,
    GrapeID        INT REFERENCES GRAPE(GrapeID) ON DELETE RESTRICT NOT NULL,
...
(
    ...
    WineID         INT REFERENCES WINE(WineID)       ON DELETE RESTRICT NOT NULL,
    StorageID      INT REFERENCES STORAGE(StorageID) ON DELETE RESTRICT NOT NULL,
...
(
    ...
    WineID           INT REFERENCES WINE(WineID)       ON DELETE RESTRICT NOT NULL,
    QualityID        INT REFERENCES QUALITY(QualityID) ON DELETE RESTRICT NOT NULL,
